...
public class DemosListFragment extends Fragment {
	/**
	...
	private final String TAG = DemosListFragment.class.getSimpleName();

	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		rootView = inflater.inflate(R.layout.frag_recyclerview_list, container, false);
		initRecycleView();
		loadData();
		return rootView;
	}
	...
	private Observable.OnSubscribe<List<ParentItem>> loadDataFromAssets() {
		return subscriber -> {
			try {
				InputStream inputStream = getResources().openRawResource(getDemosRawRes());
	...
	/**
	 * Gets the raw resource reference to be used for the {@link RecyclerView}'s data.
	 *
	 * @return The raw resource reference
	 */
	@RawRes
